 ...
 */
public class MaintenancesDeleteAdapter extends BaseAdapter{

    private final List<Maintenance> maintenances;
    private final LayoutInflater inflater;

    public MaintenancesDeleteAdapter(List<Maintenance> maintenances, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final View view = inflater.inflate(R.layout.maintenance_delete_listitem, null);
